...
export type User = {
  ...
  // Language user is speaking
  languagesspeaking?: string | null;
...
export class APIService {
  ...
  SubscribeToNewMessageListener(
    conversationId: string
  ): Observable<SubscriptionResponse<SubscribeToNewMessageSubscription>> {
  ...
  SubscribeToNewUCsListener(
    userId: string
  ): Observable<SubscriptionResponse<SubscribeToNewUCsSubscription>> {
    const statement = `subscription SubscribeToNewUCs($userId: ID!) {
